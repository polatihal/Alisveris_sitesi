...
<ul>
    <li><a href="<?php echo site."/profile?process=profile";?>"><span>Bayi Profil Bilgileri</span></a></li> 
    <li><a href="<?php echo site;?>/urunekle.php"><span>Bayi Ürün Ekle</span></a></li> 
