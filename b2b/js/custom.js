...
function kregisterbutton(){

   
    document.getElementById("kregisterbuton").disabled = true;


    var data = $("#kregisterform").serialize();
    $.ajax({
        type : "POST",
        url  : url + "/inc/uyekayıt.php",
        data : data,
        success : function(result){

            if($.trim(result) == "empty"){
                alert("Lütfen boş alan bırakmayınız");
                document.getElementById("kregisterbuton").disabled = false;
                ...
                alert("Üyeliğiniz başarıyla oluştuldu... Yönetici onayından sonra aktifleştirilecektir...");
                window.location.href = url + "/uyegirisi.php";
            }
...
function kloginbutton(){

    document.getElementById("kloginbuton").disabled = true;


    var data = $("#kloginform").serialize();
    $.ajax({
        type : "POST",
        url  : url + "/inc/uyegiris.php",
        data : data,
        success : function(result){
            if($.trim(result) == "empty"){
                alert('Boş alan bırakmayınız');
                document.getElementById("kloginbuton").disabled = false;
            }else if($.trim(result) == "error"){
 ...
 function addcart(){
    ...
    $.ajax({
        ...
        success : function(result){
            ...
            }else if($.trim(result) == "login" || $.trim(result) == "kullanici" ){
